...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | FoxieStudio - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for FoxieStudio - React.js Tailwind CSS Admin Dashboard Template"
      />
