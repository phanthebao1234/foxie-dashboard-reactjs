...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | FoxieStudio - React.js Admin Dashboard Template"
        description="This is React.js Videos page for FoxieStudio - React.js Tailwind CSS Admin Dashboard Template"
      />
